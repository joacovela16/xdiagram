...
export const XDeletePlugin = doIconTool('x-delete-plugin', () => {
    return {
        ...
        icon(theme: XTheme): string {
            return `
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="${theme.neutral}" fill="none" stroke-linecap="round" stroke-linejoin="round">
